...
# สำหรับ development ถ้าต้องการใช้ static files จาก frontend
# ใน production ควร comment บรรทัดนี้ออก
if DEBUG:
    STATICFILES_DIRS = [
...
# CORS Configuration
# สำหรับ development ใช้ CORS_ALLOW_ALL_ORIGINS = True
# สำหรับ production ควรระบุ domain ที่อนุญาต
if DEBUG:
